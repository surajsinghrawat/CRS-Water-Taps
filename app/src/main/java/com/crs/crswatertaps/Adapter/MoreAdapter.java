...
import com.crs.crswatertaps.Activity.AboutActivity;
import com.crs.crswatertaps.Activity.ContactActivity;
import com.crs.crswatertaps.Activity.MainActivity;
import com.crs.crswatertaps.Activity.ProfileActivity;
            ...
            public void onClick(View view) {
                switch (item.getCode()) {
                    ...
                    case "sha":
                        ...
                        break;
                    case "Log":
                        CustomDialogClass.showDialog(context, "Are You Sure, You Want To Logout", "Yes", "Cancel", new CustomDialogClass.WarningResponse() {
                            @Override
